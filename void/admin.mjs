...
// // Route to serve the edit discount page for admin
// // Invokes the 'editDiscountPage' function from the adminController to render edit discount page
// adminRouter.get( '/editDiscountPage/:id', adminController.editDiscountPage );

// // Route to serve the edit discount form for admin
// // Invokes the 'editDiscountForm' function from the adminController to edit discount
// adminRouter.post( '/editDiscountForm/:id', adminController.editDiscountForm );

// // Route to handle delete discount for admin
// // Invokes the 'deleteDiscount' function from the adminController to delete discount
